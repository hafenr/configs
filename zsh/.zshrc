...
fpath=("/Users/rhafen/.oh-my-zsh/custom/completions" $fpath)
...
# source $HOME/.iterm2-tab-colors.zsh
...
export PATH="$HOME/dq/scripts:$PATH"
...
# source <(fzf --zsh)  # disabled - already loaded via ~/.fzf.zsh
...
# opencode
export PATH=/Users/rhafen/.opencode/bin:$PATH

# bun completions
[ -s "/Users/rhafen/.bun/_bun" ] && source "/Users/rhafen/.bun/_bun"
